...
public:
    explicit LETSta(Expression *expression);
    ~LETSta() override;
    void execute(EvalState & state) override;
private:
    Expression *exp;
...
public:
    explicit PRINTSta(Expression *expression);
    ~PRINTSta() override;
    void execute(EvalState & state) override;
private:
    Expression *exp;
...
public:
    IFSta(string op,Expression *l,Expression *r,GOTOSta *go);
    ~IFSta() override;
    void execute(EvalState & state) override;
private:
    string op;
